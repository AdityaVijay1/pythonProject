...
champions_name = "Gibson L-5 CES"
year = 1922
cost = 16035.4

# The ‘old’ manual way to format text with string concatenation:
print("My guitar: " + champions_name + ", first made in " + str(year))

# A better way - using str.format():
print("My guitar: {}, first made in {}".format(champions_name, year))
print("My guitar: {0}, first made in {1}".format(champions_name, year))
print("My {0} was first made in {1} (that's right, {1}!)".format(champions_name, year))

# And with f-string formatting (introduced in Python 3.6)
print(f"My {champions_name} was first made in {year} (that's right, {year}!)")

# Formatting currency (grouping with comma, 2 decimal places):
print("My {} would cost ${:,.2f}".format(champions_name, cost))
print(f"My {champions_name} would cost ${cost:,.2f}")
...
print(f"{year} {champions_name} for about ${cost:,.0f}!")
