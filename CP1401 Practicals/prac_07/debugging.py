...
# No argument is passed for the parameter for the calculate_parity function
# Just returns the function used but not the value needed
...
# numnums variable should be taking integer input instead of string input.
# The loop should start from 0 till the last number and range should be used rather than taking one number character from the user input.
# end function should also be used to print the output in the desired way.
...
# The function to calculate the area is also printing the value.
# Since no value is returned from the calculating function the variable area is assigned the value "None" and displays that
...
# The function is not calculating how much will the person age in the said increament year
...
def main_4():
    ...
    while age < 0 and age > 120:
        print("Invalid age")
        age = int(input("Age: "))
    print(f"In {increment} years, you will be {age+10} years old!")
